package com.example.costumallertdialog_rizkipratama2011500015
...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnKenalan.setOnClickListener{
            val infLateView=layoutInflater.inflate(R.layout.layout_allert,null)
            ...
            with(alb){
                ...
                setIcon(R.drawable.logo_belitung_timur)
                setView(infLateView)
                setCancelable(false)
